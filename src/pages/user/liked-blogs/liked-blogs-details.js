...
import { getLikedBlogsByPrivateUser, likeBlog, resetBlogCommonState, resetUserLikedBlogState } from "../../../features/blog/blog.slice";
...
const LikedBlogsDetails = () => {
	const { likedBlogsByPrivateUser, likedBlogsMetaDataByPrivateUser, isLoading, isError, isUpdateSuccess } = useSelector((state) => state.blog);
	...
	return (
		<MuiDataTableLayout>
			<MUIDataTable
				...
				options={options(page, setPage, limit, setLimit, setSearch, isLoading, likedBlogsMetaDataByPrivateUser)}
			/>
		</MuiDataTableLayout>
	);
};
