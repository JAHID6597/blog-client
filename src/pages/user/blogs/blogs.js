...
import { deleteBlog, getBlogsByPrivateUser, resetBlogCommonState, resetUserBlogState, updateBlog } from "../../../features/blog/blog.slice";
	...
	return (
		<MuiDataTableLayout>
			<MUIDataTable
				...
				columns={blogsTableColumns(navigateToBlogUpdatePage, handleActiveBlog, handleDeleteBlog)}
				options={options(page, setPage, limit, setLimit, setSearch, isLoading, blogsMetaDataByPrivateUser)}
			/>
		</MuiDataTableLayout>
	);
};
