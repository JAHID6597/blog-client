...
import { changePassword, resetUserCommonState } from "../../../../features/user/user.slice";
...
const ChangePassword = () => {
	...
	const { isError, isUpdateSuccess, isLoading, message } = useSelector((state) => state.user);
						...
						>
							...
							>
								<Box sx={{ mt: { md: 5, xs: 3 } }}>
									...
									<Button size="large" type="submit" fullWidth variant="contained" sx={{ mt: 3 }}>Change Password</Button>
								</Box>
							</Box>
						</Box>
					</Container>
