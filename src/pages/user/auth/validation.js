const validation = (touched, formData, setSubmit, isSignup) => {
    ...
    if (touched.password) {
        if (!formData.password) {
            ...
            error.password = "Password must be at least 8 characters or longer with 1 uppercase, 1 lowercase, 1 numeric and 1 special character like @$!%*";
            isSubmit = false;
        }
    }
    ...
    if (touched.confirmPassword) { 
        ...
        else if (touched.password && formData.password !== formData.confirmPassword) { 
