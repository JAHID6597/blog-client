...
const bookmarkedBlogsTableColumns = (unBookmarkBlog) => [
	{
		name: "blog.title",
		label: "Title",
		options: {
	...
	},
	{
		...
		options: {
			...
			customBodyRender: (value, tableMeta, updateValue) => (
				<Button
					onClick={() => unBookmarkBlog(tableMeta.rowIndex)}
					variant="contained"
					color="success"
					size="small"
					sx={{ "&:hover": { color: "#fff" } }}
...
export default bookmarkedBlogsTableColumns;
