...
import { getBlogsByPublicUser, resetDataState, resetUserBlogState } from "../../features/blog/blog.slice";
...
const AllBlogs = () => {
	...
	const { blogsByPublicUser, blogsMetaDataByPublicUser, resetData } = useSelector((state) => state.blog);
