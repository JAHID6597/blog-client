...
import { Box, IconButton, List, ListItem, ListItemIcon, ListItemText, Toolbar, Typography, Collapse } from "@mui/material";
import { Close, Home, Login, Person, PersonOutline, ExpandLess, ExpandMore } from "@mui/icons-material";
	...
	return (
		<>
			<Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
				<Typography sx={{ fontSize: 25, cursor: 'pointer' }} variant="h2" onClick={() => handleItemClick('/')}>{ APP_NAME }</Typography>

				<IconButton onClick={toggleDrawer(false)}><Close sx={{ fontSize: 30 }} /></IconButton>
			</Toolbar>
