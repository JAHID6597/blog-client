		...
		>
			...
			>
				<Box sx={{ height: "100%", width: "100%", display: "flex", alignItems: "center", justifyContent: "center" }} >
					<Typography variant="h2" sx={{ fontSize: { md: "25px", sm: "20px", xs: "25px"}, p: 1 }}>
						{ isDragActive ? "Release to upload image." : "Choose a image or Drag it here." }
					</Typography>
				</Box>
		  </Box>
		  
			<img src={image} alt="Img" style={{ height: "100%", width: "100%" }} />
		</Box>
	);
}
