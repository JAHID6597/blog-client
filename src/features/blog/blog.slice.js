...
export const getBlog = createAsyncThunk('blog/get-blog', async (slug, thunkAPI) => {
	try {
...
export const getBlogs = createAsyncThunk('blog/get-blogs', async (data={}, thunkAPI) => {
	try {
		const { page, limit, search, category, tag } = data;

        return await blogService.getBlogs(page, limit, search || "", category || "", tag || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const deleteBlog = createAsyncThunk('blog/delete-blog', async (slug, thunkAPI) => {
	try {
		const token = thunkAPI.getState().user.user.accessToken;
...
export const getReadNextBlogs = createAsyncThunk('blog/get-read-next-blogs', async (data={}, thunkAPI) => {
	try {
...
export const likeBlog = createAsyncThunk('blog/like-blog', async (slug, thunkAPI) => {
	try {
		const token = thunkAPI.getState().user.user.accessToken;
...
export const bookmarkBlog = createAsyncThunk('blog/bookmark-blog', async (slug, thunkAPI) => {
	try {
		const token = thunkAPI.getState().user.user.accessToken;
...
export const getComment = createAsyncThunk('blog/get-comment', async (data={}, thunkAPI) => {
	try {
		const { slug, id } = data;
...
export const getComments = createAsyncThunk('blog/get-comments', async (data={}, thunkAPI) => {
	try {
		const { slug, page, limit, search} = data;

        return await blogService.getComments(slug, page, limit, search || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const createComment = createAsyncThunk('blog/create-comment', async (data={}, thunkAPI) => {
	try {
		const { formData, slug } = data;
		const token = thunkAPI.getState().user.user.accessToken;
...
export const updateComment = createAsyncThunk('blog/update-comment', async (data={}, thunkAPI) => {
	try {
...
export const deleteComment = createAsyncThunk('blog/delete-comment', async (data={}, thunkAPI) => {
	try {
		const { slug, id } = data;
		const token = thunkAPI.getState().user.user.accessToken;
...
export const getCommentsByPublicUser = createAsyncThunk('blog/get-comments-by-public-user', async (data={}, thunkAPI) => {
	try {
		const { userName, page, limit, search} = data;

        return await blogService.getCommentsByPublicUser(userName, page, limit, search || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getBlogsByCategory = createAsyncThunk('blog/get-blogs-by-category', async (data={}, thunkAPI) => {
	try {
		const { slug, page, limit, search } = data;
        return await blogService.getBlogsByCategory(slug, page, limit, search || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getBlogsByTag = createAsyncThunk('blog/get-blogs-by-tag', async (data={}, thunkAPI) => {
	try {
		const { slug, page, limit, search } = data;
        return await blogService.getBlogsByTag(slug, page, limit, search || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getBlogByPublicUser = createAsyncThunk('user/get-blog-by-public-user', async (data, thunkAPI) => {
	try {
...
export const getBlogsByPublicUser = createAsyncThunk('user/get-blogs-by-public-user', async (data={}, thunkAPI) => {
	try {
		const { userName, page, limit, search } = data;

        return await blogService.getBlogsByPublicUser(userName, page, limit, search || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getBlogByPrivateUser = createAsyncThunk('user/get-blog-by-private-user', async (slug, thunkAPI) => {
	try {
		const token = thunkAPI.getState().user.user.accessToken;
...
export const getBlogsByPrivateUser = createAsyncThunk('user/get-blogs-by-private-user', async (data={}, thunkAPI) => {
	try {
		const token = thunkAPI.getState().user.user.accessToken;
		const { page, limit, search } = data;

        return await blogService.getBlogsByPrivateUser(page, limit, search || "", token);
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getLikedBlogsByPublicUser = createAsyncThunk('user/get-liked-blogs-by-public-user', async (data={}, thunkAPI) => {
	try {
		const { userName, page, limit, search } = data;

        return await blogService.getLikedBlogsByPublicUser(userName, page, limit, search || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getLikedBlogsByPrivateUser = createAsyncThunk('user/get-liked-blogs-by-private-user', async (data={}, thunkAPI) => {
	try {
		const token = thunkAPI.getState().user.user.accessToken;
		const { page, limit, search } = data;

        return await blogService.getLikedBlogsByPrivateUser(page, limit, search || "", token);
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getBookmarkedBlogsByPublicUser = createAsyncThunk('user/get-bookmarked-blogs-by-public-user', async (data={}, thunkAPI) => {
	try {
		const { userName, page, limit, search } = data;

        return await blogService.getBookmarkedBlogsByPublicUser(userName, page, limit, search || "");
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
...
export const getBookmarkedBlogsByPrivateUser = createAsyncThunk('user/get-bookmarked-blogs-by-private-user', async (data={}, thunkAPI) => {
	try {
		const token = thunkAPI.getState().user.user.accessToken;
		const { page, limit, search } = data;

        return await blogService.getBookmarkedBlogsByPrivateUser(page, limit, search || "", token);
    }
    catch (error) {
        const message = (error.response && error.response.data) || (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
	...
	extraReducers: builder => {
		builder
            ...
            .addCase(updateBlog.fulfilled, (state, action) => {
				...
				state.blogsByPrivateUser = state.blogsByPrivateUser.map(blg => blg._id === action.payload._id ? action.payload : blg);
				state.isUpdateSuccess = true;
            })
            ...
            .addCase(createComment.fulfilled, (state, action) => {
				...
				state.blog = {...state.blog, comments: [{ _id: action.payload._id, user: action.payload.user }, ...state.blog.comments]};
            })
            ...
            .addCase(getLikedBlogsByPublicUser.fulfilled, (state, action) => {
				fulfilledState(state);
				state.likedBlogsByPublicUser = action.payload.blogs.map(blg => blg?.blog);
            ...
            .addCase(getBookmarkedBlogsByPublicUser.fulfilled, (state, action) => {
				fulfilledState(state);
				state.bookmarkedBlogsByPublicUser = action.payload.blogs.map(blg => blg?.blog);
				state.bookmarkedBlogsMetaDataByPublicUser = action.payload.metaData;
            })
            .addCase(getBookmarkedBlogsByPublicUser.rejected, (state, action) => {
                rejectedState(state, action.payload);
			})
			.addCase(getBookmarkedBlogsByPrivateUser.pending, (state) => {
                state.isLoading = true;
            })
            .addCase(getBookmarkedBlogsByPrivateUser.fulfilled, (state, action) => {
				fulfilledState(state);
				state.bookmarkedBlogsByPrivateUser = action.payload.blogs;
				state.bookmarkedBlogsMetaDataByPrivateUser = action.payload.metaData;
            })
            .addCase(getBookmarkedBlogsByPrivateUser.rejected, (state, action) => {
                rejectedState(state, action.payload);
			})
	}
})

export const { resetDataState, resetBlogState, resetBlogCommentState, resetBlogActionState, resetBlogCommonState, resetBlogByCategoryState, resetBlogByTagState, resetUserBlogState, resetUserLikedBlogState, resetUserBookmarkedBlogState, resetUserCommentState } = blogSlice.actions;
