...
export const getTag = createAsyncThunk('tag/get-tag', async (slug, thunkAPI) => {
	try {
...
export const getTags = createAsyncThunk('tag/get-tags', async (data={}, thunkAPI) => {
	try {
...
export const { resetDataState, resetState, resetTagBlogActionState } = tagSlice.actions;
